...
<div id="container">
		...
		<td colspan=8 style="width: 30px;"><?php $x=getdetails($mid*2+1); if($x){ echo $x['name'].'/'.$x['userid']."<br/><a href='tree.php?mid=".($mid*2+1)."'><img src='images/tree1.png' /> </a>"; } else echo "<img src='images/tree0.png'/>";?></td> </tr>
            <tr align="center">
		...
		<td style="width: 30px;" colspan=4><?php $x=getdetails($mid*4+3); if($x){ echo $x['name'].'/'.$x['userid']."<br/><a href='tree.php?mid=".($mid*4+3)."'><img src='images/tree1.png' /> </a>"; }else echo "<img src='images/tree0.png'/>";?></td></tr>
            <tr align="center">
