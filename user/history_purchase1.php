...
{
$.ajax({
  url: "history_purchase2.php?a="+x+"&b="+<?php echo $bill_id;?>,
}).done(function(data) {
...
$.ajax({
  url: "changebillid.php?b="+<?php echo $bill_id;?>,
}).done(function(data) {
...
<div style="width:100%; height:auto; float:left;">
		<div style="width:98%; height:600px; margin-left:1%;">
...
<div id="contentbar" style="margin-top:15px; height:auto;">
		   ...
		   <div class="orderbox"  style="width:735px; height:auto; margin-left:0%; padding-bottom:2%; ">
				 <h1> Purcahse History</h1>
				 	<div class="box" style="width:735px;height:auto; margin-bottom: 15px; font-family:arial;">
...
<table cellpadding="4" cellspacing="10" style="font-family:arial;">
     <?php
     $sqlord=mysql_query("select * from `order_details` where `id`='$bill_id'");
$resord=mysql_fetch_array($sqlord);
     ?>
     <tr>
     <td><?php echo $resord['order_ondate'];?></td>
</tr>
 <tr>
							 <th>Product Name</th>
							 <th>Quantity</th>
