			...
			<div class="billing-content">
					<div id="w" class="clearfix">
							<ul id="sidemenu">
							  ...
							  <li>
								<a href="#contact-content" class="open"><i class="icon-envelope icon-large"></i><strong>Contact Us</strong></a>
							  </li>
							</ul>
...
contact@luvviz.com</p>
								...
								<div id="contact-content" class="contentblock">
										  ...
										  <p style="line-height:1.6;">Plot no-109, Bhimpur,<br /> West aerodrome area, Bhubaneswar, India, 751020<br />
Phone- 0674-2596030 Mobile- 09861955556<br />
