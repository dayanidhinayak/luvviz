...
$que=mysql_query("select * from `user_details` where `email`='$email'");
$res=mysql_fetch_array($que);

?>
<form name="ww" method="post" action="profile1.php">
<table>
<tr>
<td>First Name</td>
<td><input type="text" name="fname" value="<?php echo $res['first_name'];?>"></td>
</tr>	
<tr>
<td>Last Name</td>
<td><input type="text" name="lname" value="<?php echo $res['last_name'];?>"></td>
</tr>	
<tr>
<td>Email</td>
<td><input type="text" name="email" value="<?php echo $res['email'];?>" readonly></td>
</tr>	
<tr>
<td>Contact</td>
...
<tr>
<td>Country</td>
<td><input type="text" name="country" value="<?php echo $res['country'];?>"></td>
</tr>	
<tr>
<td>State</td>
<td><input type="text" name="state" value="<?php echo $res['state'];?>"></td>
</tr>	
<tr>
<td>City</td>
...
<tr>
<td>Pin</td>
<td><input type="text" name="pin" value="<?php echo $res['pin'];?>"></td>
</tr>	
<tr>
<td>Address</td>
...
<tr>
<td>Delivery Date</td>
<td><input type="text" name="deliverydate" value="<?php echo $res['deliverydate'];?>"></td>
</tr>
<tr>
