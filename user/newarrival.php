...
if($brandid!="")
{
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$pid|%' and p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`category_id` desc'");

$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`category_id` like '%|$pid|%' and p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`created_ondate` desc'");
}
else
{
$totalq=mysql_query("select * from `product`  where `category_id` like '%|$pid|%' and `status`='1' and `newarrival`='1'  order by `category_id` desc");

$totalpriceval=mysql_query("select max(`price`) as highestprice,min(`price`) as lowestprice  from `product` where `category_id` like '%|$pid|%' and `status`='1' and `newarrival`='1'  order by `created_ondate` desc");
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`category_id` desc'");

$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`created_ondate` desc'");
}
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`brand_id` =b.`id` and p.`status`='1' and p.`newarrival`='1' order by p.`category_id` desc");

$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`status`='1' and p.`newarrival`='1' order by p.`created_ondate` desc'");
}
...
if($brandid!="")
{
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$pid|%' and p.`status`='1' and p.`newarrival`='1' and b.`id`=p.'$brand_id' order by p.`created_ondate` desc");


$totalpriceval=mysql_query("select max(p.`price`) as highestprice, min(p.`price`) as lowestprice from `product` p,`brand` b where p.`category_id` like '%|$pid|%' and p.`status`='1' and p.`newarrival`='1' and b.`id`=p.'$brand_id' order by p.`created_ondate` desc");

}
else
{

$totalq=mysql_query("select * from `product`  where `category_id` like '%|$pid|%' and `status`='1' and `newarrival`='1' order by `created_ondate` desc");


$totalpriceval=mysql_query("select max(`price`) as highestprice, min(`price`) as lowestprice from `product`  where `category_id` like '%|$pid|%' and `status`='1' and `newarrival`='1' order by p.`created_ondate` desc");
...
$totalq=mysql_query("select * from `product`  where `status`='1' and `newarrival`='1' order by `created_ondate` desc");


$totalpriceval=mysql_query("select max(`price`) as highestprice, min(`price`) as lowestprice from `product`  where `status`='1' and `newarrival`='1' order by p.`created_ondate` desc");
}
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b,`product_varient` pv where p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' and pv.`description`='$desc' and pv.`product_id`=p.`id` and pv.`varient_name`='$feature' order by p.`created_ondate` desc")or die(mysql_error());


$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice from `product` p,`brand` b,`product_varient` pv where p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' and pv.`description`='$desc' and pv.`product_id`=p.`id` and pv.`varient_name`='$feature' order by p.`created_ondate` desc")or die(mysql_error());
...
$low=$_GET['low'];
$high=$_GET['high'];
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$pid|%' and p.`status`='1' and p.`newarrival`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' and p.`price`>='$low' and p.`price`<='$high' order by p.`created_ondate` desc")or die(mysql_error());
...
<td class="para"><a href="newarrival.php?idval=<?php echo $_GET['idval']?>&type=brand&bid=<?php echo $result1['brand_id']?>"><?php echo $result2['brand_name'];?></a>
	...
	?>
		...
		<p  class="para"><a href="newarrival.php?idval=<?php echo $_GET['idval']?>&type=brand&bid=<?php echo $_GET['bid']?>&low=<?php echo $fromv?>&high=<?php echo $to?>">Rs.<?php echo $fromv?>-Rs.<?php echo $to?></a></p>
