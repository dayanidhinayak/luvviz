...
{
echo $r['id'];
echo "select t.*,p.`product_name`,p.`price` from `temp_billinfo`  t,`product` p where t.`bill_id`='$r[id]' and t.`product_id`=p.`id`";
...
<td><?php echo $r1['price'];?>*<?php echo $r1['quantity'];?></td>
</tr>
<?php
}
?>
