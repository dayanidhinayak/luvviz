...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' order by p.`price` asc");
 
 //echo "select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`price` desc'";

$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`created_ondate` desc");

}
else{

$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and b.`id`='$brandid' order by p.`price` asc");



$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and b.`id`='$brandid' order by p.`created_ondate` desc");
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' order by p.`price` desc");
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and b.`id`='$brandid' order by p.`price` desc");
...
$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid' and p.`newarrival`=1 order by p.`created_ondate` desc");
 
 //echo "select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid order by p.`price` desc'";

$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and p.`brand_id`='$brandid' and b.`id`='$brandid and p.`newarrival`=1 order by p.`created_ondate` desc'");

}
else{

$totalq=mysql_query("select p.*,b.`brand_name` from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and b.`id`='$brandid' and p.`newarrival`=1 order by p.`created_ondate` desc");



$totalpriceval=mysql_query("select max(p.`price`) as highestprice,min(p.`price`) as lowestprice  from `product` p,`brand` b where p.`category_id` like '%|$proid|%' and p.`status`='1' and b.`id`='$brandid' and p.`newarrival`=1 order by p.`created_ondate` desc");
...
{
$totalq=mysql_query("select * from `product`  where `category_id` like '%|$proid|%' and `status`='1'  order by `price` desc");
$rtot=mysql_fetch_array($totalq);
$prid=$rtot['id'];
$totalpriceval=mysql_query("select max(`price`) as highestprice,min(`price`) as lowestprice  from `product` where `category_id` like '%|$proid|%' and `status`='1'  order by `created_ondate` desc");
