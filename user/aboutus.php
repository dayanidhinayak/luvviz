		...
		<div style="width:900px; margin:auto;">
			<div class="billing-content">
					<div id="w" class="clearfix">
							<ul id="sidemenu">
								<li>
								<a href="#ideas-content" class="open"><i class="icon-lightbulb icon-large"></i><strong>About Us</strong></a>
							  </li>
							  <li>
							  ...
							  <li>
								<a href="#about-content"><i class="icon-info-sign icon-large"></i><strong>Help</strong></a>
							  </li>
							  <li>
							...
							<div id="content" style="width:90%; margin-left:0px; margin-top:0px;	">
								...
								<div id="home-content" class="contentblock hidden">
										  <h1>Shipping</h1>
										  <p style="line-height:1.7;">We have a team to deliver the products at your door step.<br />
...
The order will be cancelled and your refund, if any, will be processed within 7 days. 
								...
								<div id="about-content" class="contentblock hidden">
										  ...
										  <p style="line-height:1.6;">For any help, Mail us 
contact@luvviz.com</p>
								...
								<div id="contact-content" class="contentblock hidden">
										  ...
										  <p>Plot no-109, Bhimpur,<br /> West aerodrome area, Bhubaneswar, India, 751020
Phone- 9778003030<br />
