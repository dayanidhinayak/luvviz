...
include_once("function.php");
								...
								?>
								<div id="content4_box" style="width:730px; margin-top: 15px; height:auto; border:none;">
								<div style="width:730px; float:left; height:auto; border:1px solid #cccccc;"> 

						<div id="content4_top" style="width:730px;"><p style="font-weight:bold; margin-top:10px; margin-left:10px;"><?php echo $_POST['search']?></p></div>
						<?php
							
						
							
						
								$totalq=mysql_query("SELECT *,id as productid FROM `product` where `product_name` like '%$_POST[search]%'");
