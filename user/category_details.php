...
<div id="contentbar" style="height:auto;">
			...
			<?php
				 ...
				 $bid_temp=$r_brand['id'];
							...
							<?php
							$qwe=mysql_query("select * from `category` where `parent`='$cid' order by `priority` ");
						while($res=mysql_fetch_array($qwe))
						{
						$q_brand1=mysql_query("select * from brand where `brand_name`='$res[category_name]'");
				 $r_brand1=mysql_fetch_array($q_brand1);
				 $bid_temp1=$r_brand1['id'];
							?>
							
								<a href="productdetails.php?idval=<?php echo $res['id']?>&type=brand&bid=<?php echo $bid_temp1; ?>"><div class="contentrightbox" style="width:225px; height:300px; float:left; " >
									<div style="float:left;">
										<img src="../admin_new/inventory_management/<?php echo $res['img'];?>" style="width:200px; height:250px;"  />
									</div>
