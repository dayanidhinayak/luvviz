...
<title>...:::MAPKART:::...</title>
<link href="jabong/style.css" rel="stylesheet" type="text/css" />


<!-- Include JavaScript -->
        <script type="text/javascript" src="jabong/jquery_002.js"></script>
        <script type="text/javascript" src="jabong/jquery.js"></script>        
        
<script type="text/javascript" src="jabong/jquery-1.9.1.min.js" charset="utf-8"></script>
        <script type="text/javascript" src="jabong/script.js"></script>
 ...
 <link href="jabong/admin_002.css" rel="stylesheet" type="text/css" media="all">

 <link rel="stylesheet" href="jabong/styles.css">
  
 
 <script src="jabong/tabcontent.js" type="text/javascript"></script>
...
function view_second (elem, helperMsg){
...
<div id="topbar"> 
			<div id="topbarbox">
			  <div id="logo"><img src="jabong/images/logo.jpg" /></div>
			  <div style="height:40px; width:680px; float:left; margin-top:40px; margin-left:50px;">
			  		<div class="topsmallbox1"><img src="jabong/images/checkout1.jpg" style="float:left; " /> </div>
					<div class="smalltextbox1">FREE SHIPPING</div>
					
					<div class="topsmallbox1"><img src="jabong/images/checkout2.jpg" style="float:left; " /> </div>
					<div class="smalltextbox1" style="margin-left:10px; width:60px;">CASH ON<br />
DELIVERY</div>
					
					<div class="topsmallbox1"><img src="jabong/images/checkout3.jpg" style="float:left; " /> </div>
					<div class="smalltextbox1" style="margin-left:10px;">30 DAYS
RETURNS</div>
					
					<div class="topsmallbox1"><img src="jabong/images/checkout5.jpg" style="float:left; " /> </div>
					<div class="smalltextbox1" style="margin-left:17px;">CUSTOMER CARE
0124-6128000</div>
					
					<div class="topsmallbox1" style="margin-left:60px;"><img src="jabong/images/shoppimgimg12.jpg" style="float:left; " /> </div>
							...
							<div style="height:auto; width:640px; float:left; border:1px #CCCCCC solid;">
										<div style="height:45px; width:640px; float:left; background:#ededed;">
										 ...
										 <ul class="tabs" persist="true" style="list-style:none; margin-top:0px; margin-left:0px;" >
													...
													<img src="jabong/images/checkoutimg1.jpg"
            ...
            <div id="view1" class="tabcontent">
                ...
                <table width="438" border="0">
													  <tr>
														...
														<td><input type="text" name="emailid" id="email" style="width:140px;" /></td>
													  </tr>
													  <tr>
													  ...
													  <tr>
														...
														<td class="botton1" style="height:12px; width:100px; font-weight:bold; color:#FFFFFF; font-size:14px; " onclick="return view_second(document.getElementById('email'), 'Please Enter a Value');"  >Order Now <img src="jabong/images/shopping.png"/></td>
													  </tr>
									 </table>
                ...
                <div style=" height:auto; width:500px; float:left;">
								   <table width="413" border="0">
													  ...
													  <tr>
														...
														<td>+91
													    <input type="text" name="Input2" id="Input2" style="width:114px;" /></td>
													  </tr>
													   <tr>
													  ...
													  <tr>
														<td style="text-align:right;"></td>
														<td class="botton1" style="height:12px; width:100px; font-weight:bold; color:#FFFFFF; font-size:14px; " onclick="return view_third();" >Order Now <img src="jabong/images/shopping.png"  /></td>
													  </tr>
									 </table>
			  </div>
            </div>
...
<span style="font-weight:bold; color:#00CC33;">Save Rs. 39</span> by paying through Credit/Debit Card or Net-Banking </p>
				 ...
				 <div class="botton1" style=" float:left; margin-top:5px; color:#FFFFFF; font-weight:bold; margin-bottom:10px; ">Order Now <img src="jabong/images/shopping.png" style="margin-left:5px;"  /></div>
                </div>
                     ...
                     <div style="height:350px; width:350px; float:left; margin-top:0px; border:1px solid #CCCCCC; ">
						...
						<p style="font-size:11px; margin-left:5px;">Pay using our Net Banking service.
						       ...
						       <table width="100%" border="0">
									  ...
									  <tr>
										<td>&nbsp;</td>
										<td><div class="botton1" style=" height:20px; width:120px; float:left; color:#FFFFFF; font-weight:bold; margin-bottom:10px; ">Order Now <img src="jabong/images/shopping.png" style="margin-left:5px;"  /></div></td>
									  </tr>
	            ...
	            <div style="display:none; height:auto;  width:270px; border:1px solid #CCCCCC; " class="tab-content">
                  <div style="height:100px; width:250px; float:left; margin-left:10px;">
				       <div style="height:60px; width:250px; float:left; border-bottom:1px solid #CCCCCC; ">Pay using <img src="jabong/images/img10.jpg"  style=" margin-top:10px;  " /> <img src="jabong/images/img10.jpg" style=" margin-top:5px;" />(Only domestic cards accepted)
				       </div>
	              ...
	              <table width="213" border="0">
                    ...
                    <tr>
                      <td style="text-align:right;"></td>
                      <td class="botton1" style="height:12px; width:100px; font-weight:bold; color:#FFFFFF; font-size:14px; ">Order Now <img src="jabong/images/shopping.png"  /></td>
                    </tr>
                  </table>
	              </div>
                </div>
				          ...
				          <div style="height:auto; width:280px; float:left; border:1px solid #CCCCCC; margin-left:20px;">
						    <h2 style="margin-top:4px; margin-left:4px; margin-bottom:0px;">Order Summary</h2>
										...
										<span style="margin-left:10px;">Price</span>
											 ...
											 <div class="content5smallbox" style="height:80px; width:90px; line-height:1.3; margin-top:0px; "><img src="jabong/images/shoppimgimg1.jpg"   /> <p style="font-weight:bold; font-size:11px; margin-top:0px;">Adidas<br />
...
<div style="margin-top:10px; float:left;"><input type="text" name="" />
  <input name="button" type="button" value="Apply"/>
						  ...
						  <div style="height:100px; width:960px; float:left;">
						  			...
						  			<div style="height:60px; width:960px; border-bottom:1px solid #CCCCCC; float:left;"><img src="jabong/images/checkout10.jpg" style="float:left;" /><img src="jabong/images/shoppimgimg12.jpg" style="float:right;" /></div>
