...
<body>
		...
		<div style="float:left; padding-left:1%;"><h3>Catalog <img src="images/separator1.png" /> Categories </h3></div>
		...
		<div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;"><img src="images/addnew.png" /><br/>Add new Values</div>
			<div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;"><img src="images/addnew.png" /><br/>Add new Attributes </div>
			</div>
			...
			<div class="box1" style="width:100%; margin-left:0px;">
				<table cellpadding="10" cellspacing="0" style="width:100%;">
					...
					<tr>
						...
						<td align="center"><input type="text" name="" style="width:250px; border:1px solid #efefef; " /></td>
					...
					<tr>
						...
						<td>iPods</td>
						<td  align="center">Now that you can buy movies from the iTunes Store and sync them to your iPod, the whole world is your theater. </td>
