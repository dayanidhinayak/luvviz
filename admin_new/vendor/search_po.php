...
$query=mysql_query("select po.`order_id`,po.`quantity`,po.`entry_date`,po.`id`,p.`product_name` from `purchase_order` po,`product` p  where `order_by`='$_SESSION[user]' and p.`id`=po.`product_name` and p.`product_name` like '$inv%'");
