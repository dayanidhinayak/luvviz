 ...
 if($ext1=="jpg" || $ext1=="jpeg" || $ext1=="png" || $ext1=="gif")
	...
	$folder="img/";
	 ...
	 $copied = copy($_FILES['prodct_img']['tmp_name'], $filename);
		...
		`alternate_val`='$alt',`releated_pro_id`='$related_pro',`tax_value`='$taxval',`deliverytimeperiod`='$dtime',`newarrival`='$newarrival',`metatitle`='$metatitle',`metadescription`='$metadescription',`metakeyword`='$metakeyword',`quantity`='$qty',`barcodeno`='$barcode',`priority`='$priority',`addtype`='vendor'")or die(mysql_error());
