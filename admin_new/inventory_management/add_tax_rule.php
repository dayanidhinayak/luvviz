...
<body>
		...
		<form action="insert_tax_rule.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="taxname" style=" border:1px solid #CCCCCC;"/></td>
  ...
  <tr>
	...
	<?php 
	$q=mysql_query("select * from `taxes` where `status`='1'");
	while($r=mysql_fetch_array($q))
	{
	?>
	<option value="<?php echo $r['slno'];?>"><?php echo $r['tax_name'];?></option>
