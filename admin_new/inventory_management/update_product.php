...
$varid=$x[1];
$qqd=strtolower($q);
$str="`varient_name`='$varnme',`description`='$qqd'";
//echo "---".$str;
...
mysql_query("update `product_varient` set `description`='$qqd' where `product_id`='$id' and `varient_name`='$varnme' and `id`='$varid'");
//echo "update `product_varient` set `description`='$q' where `product_id`='$id' and `varient_name`='$varname' and `id`='$varid'";
