...
<body>
		...
		<div style="float:left;"><h3>Customization <img src="../images/separator1.png" /> Add Page Customization</h3></div>
		...
		<form name="form1" id="form1" method="post" action="pagecustomisation_insert.php" enctype="multipart/form-data">
	   ...
	   <br/>Save</div>
			...
			<tr style="border:none; background:none;">
							...
							<?php
							$q=mysql_query("select * from `page_details`");
							while($r=mysql_fetch_array($q))
							{
							
							?>
							<option value="<?php echo $r['id'];?>"><?php echo $r['pagename'];?></option>
