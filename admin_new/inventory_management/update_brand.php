...
<body>
		...
		$sql=mysql_query("select * from `brand` where `id`='$id'")or die(mysql_error());
		...
		<form action="update_dbbrand.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="product_name" style=" border:1px solid #CCCCCC;" value="<?php echo $result['brand_name'];?>"/></td>
   ...
   <tr>
	...
	<input type="radio" name="display" value="0" /><img src="../images/disabled.gif" />
	...
	<input type="radio" name="display" value="0" checked="checked"/><img src="../images/disabled.gif" />
   ...
   <tr>
    ...
    <td >Priority:<input type="hidden" name="hidden" value="<?php echo $result['id']; ?>" /> </td>

    <td><input type="text" name="priority" style=" border:1px solid #CCCCCC;" value="<?php echo $result['priority']; ?>" /></td>
  ...
  <td> <img src="<?php echo $result['icon'];?>" width="50px" height="60px" /></td>
