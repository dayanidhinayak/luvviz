...
<body>
		...
		<?php include_once($path.'/menubar.php');?>
			
		
		<div id="container">
			
			<form name="form" action="addcart1.php" method="post" >
		...
		?>
		<a href="<?php echo $prev; ?>"><div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;">
        <img  src="../images/process1.png"/><br/>Back to list</div></a>
        ...
        <input type="submit" name="submit" style="background:url('images/save5.png'); border:none; height:32px; width:32px;" value=""/><br/>Save
		  	...
		  	<div class="box1" style="width:100%; margin-left:0px; background:#ebedf4; border-bottom: 1px solid #CCCCCC;">
                ...
                <div style="display:block; " class="tab-content">
                  ...
                  <table width="62%" border="0" height="150px;" style="float:left;  margin-left:15%;	 ">
                    ...
                    <tr>
                      <td width="15%" >Name:</td>
                      <td colspan="2"><input type="text" name="name" style=" border:1px solid #CCCCCC; width:90%;"/>
                          <br />
                    ...
                    <tr>
                      <td>Description: </td>
					  <td><textarea name="description" rows="9" cols="50" style=" border:1px solid #CCCCCC;"/></textarea></td>
				...
				<div style="display:none;" class="tab-content">
					 ...
					 <div id="separation" style="width:100%; margin-left:0%;">
                      ...
                      <td colspan="2"><input type="text" name="Input" style=" border:1px solid #CCCCCC; width:90%;"/>
						...
						<tr>
							<td>Valid</td>
							<td>From<input type="text" name="from"  id="from"  style="width:100px; height:20px; border:1px solid #CCCCCC;" readonly=""/> to <input type="text" name="to"  id="to" style="width:40%;  border:1px solid #CCCCCC;" readonly="" />
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
