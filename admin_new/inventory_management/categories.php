...
var msg=confirm("Are you sure You Want To Delete This Category??");
			 ...
			 if(msg==true)

					  {
						...
						$.ajax({
                    url: "delete_category.php?id="+hdnvalue,
...
xmlhttp.open("GET","display_category.php?q="+val,true);
...
<body>
		...
		<!--<div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;"><img src="images/addnew.png" /><br/>Add new Values</div>-->
			<div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;"><a href="add_category.php" ><img src="images/addnew.png" /></a><br/>Add new Category </div>
			</div>
			...
			<form name="form1" id="form1" method="post" action="selected_deletecat.php">
				<table cellpadding="10" cellspacing="0" style="width:100%;">
					...
					<tr id="<?php echo $result['id'];?>">
						...
						?>
						<td><a href="update_category.php?id=<?php echo $result['id'];?>"><img src="../images/edit.gif" /></a> &nbsp;
