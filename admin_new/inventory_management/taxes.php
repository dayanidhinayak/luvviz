...
xmlhttp.open("GET","enable_tax.php?q="+id+"&status="+status,true);
...
xmlhttp.open("GET","find_taxajax.php?idval="+idval+"&nameval="+nameval+"&priceval="+priceval,true);
...
xmlhttp.open("GET","display_taxajax.php?q="+val,true);
...
<body>
		...
		<div style="float:left;"><h3>Localization <img src="../images/separator1.png" /> Taxes</h3></div>

		<div style="float:right; margin-right:10px; margin-top:20px; font-size:12px; font-family:Arial, Helvetica, sans-serif;  text-align:center;"><a href="addnewtaxes.php"><img src="../images/addnew.png" /></a><br/>Add New</div>
			...
			<form name="form1" id="form1" method="post" action="selected_taxdelete.php">
				...
				<table cellpadding="10" cellspacing="0" style="width:100%;">
					...
					<tr>
						...
						<td><input type="text" name="" style="width:100px; border:1px solid #efefef;"  id="priceval"/></td>
				...
				$query=mysql_query("select * from `taxes`");
				...
				?>
					...
					<tr>
						...
						<td><input type="checkbox" name="tax[]" value="<?php echo $res['slno'];?>" /></td>
