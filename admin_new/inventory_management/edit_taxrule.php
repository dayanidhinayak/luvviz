...
$q=mysql_query("select tr.*,t.`tax_name` from `tax_rule` tr,`taxes` t where tr.`id`='$id' and t.`slno`=tr.`tax_id`");
...
<body>
		...
		<form action="update_tax_rule.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="taxname" style=" border:1px solid #CCCCCC;" value="<?php echo $r['name'];?>"/>
  ...
  <tr>
    ...
    <td width="21%" >Select Tax:</td>

    <td colspan="2"><select name="rate" style=" border:1px solid #CCCCCC;"/>
	<option value="<?php echo $r['tax_id'];?>"><?php echo $r['tax_name'];?></option>
	<?php 
	$q1=mysql_query("select * from `taxes` where `status`='1' and `slno`!='$r[tax_id]'");
	while($r1=mysql_fetch_array($q1))
	{
	?>
	<option value="<?php echo $r1['slno'];?>"><?php echo $r1['tax_name'];?></option>
...
{
?>
    <td width="37%"><input type="radio" name="display" value="1" checked="checked"/><img src="images/tick.png" /><input type="radio" name="display" value="0" /><img src="../images/disabled.gif" /></td>
<?php 
}
else
{
?>
<td width="37%"><input type="radio" name="display" value="1"/><img src="images/tick.png" /><input type="radio" name="display" value="0" checked="checked"/><img src="../images/disabled.gif" /></td>
<?php } ?>	 
