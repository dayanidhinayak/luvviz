...
<body>
	<?php 
		...
		<div style="width:100%; height:auto; float:left; margin-top:3%;  margin-left:3%;">
		<div class="boxdt" >
		<table>
		<tr>
		 <th>Id</th>
...
$sqlorder=mysql_query("select * from `order_details` where `id`='$id'");
...
?>
							...
							<td>
							 <a href="customerhistory1.php?id=<?php echo $resorder[id];?>&status=<?php echo $resorder[status];?>" style="text-decoration: none;">
