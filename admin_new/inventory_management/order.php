			...
			<div class="box1" style="width:100%; margin-left:0px;">
				<table cellpadding="10" cellspacing="0" style="width:100%;">
					...
					<tr>
						...
						<td><input type="text" name="idval" id="idval" style="width:50px; border:1px solid #efefef;" /></td>
						<td>	<select onchange="return display(this.value);">
							<option value="" ></option>
							<option value="1">Yes</option>
							<option value="0">No</option>
						</select>
						</td>
						<td><input type="text" name="nameval" id="nameval" style="width:300px; border:1px solid #efefef;" /></td>
						<td><input type="text" name="totval" id="totval" style="width:100px; border:1px solid #efefef;" /></td>
						<td><input type="text" name="paymentval" id="paymentval"style="width:100px; border:1px solid #efefef;" /></td>
						<td>
						<select name="statusval" id="statusval">
							<option value="1" >Delivered</option>
							<option value="0" >Pending</option>
						</select>
						</td>
						<td style="text-align:right;">From<input type="text" name="fromval" id="fromval" style="width:100px; border:1px solid #efefef;" /><br/><br/>
						    To<input type="text" name="toval"  id="toval" style="width:100px; border:1px solid #efefef;" />
						</td>
						<td>-</td>
						<td>-</td>
					</tr>
					...
					$q=mysql_query("select `slno`,`id`,`billing_name`,`billing_phn`,`pay_type`,`status`,`order_ondate` from `order_details` where `status`='1' order by `order_ondate` desc") or die(mysql_error());
while($r=mysql_fetch_array($q))
{
					...
					while($r1=mysql_fetch_array($q1))
					{
						...
						<td><input type="button"  name="submit" value="Dispatched" style="background:#006633; color:#FFFFFF; border-radius:3px; -moz-border-radius:3px; border:none;" /></td>
						...
						<td><a href="orderdetails.php?id=<?php echo $r['id'];?>"><img src="../images/details.gif" /></a></td></tr>
						<?php } ?>
...
while($r=mysql_fetch_array($q))
{
					...
					while($r1=mysql_fetch_array($q1))
					{
						...
						<td>
						<!--<input type="button" name="submit" id="deliver" value="Pending" style="cursor:pointer;background:#006633; color:#FFFFFF; border-radius:3px; -moz-border-radius:3px; border:none;" />-->
