...
xmlhttp.open("GET","viewproduct_cat.php?q="+key,true);
...
<div id="container100" style=" margin-top:10px; background:#ffffff;">
	...
	<div style="width:850px">		
		<div style="width:250px;height:auto;font-size:20px; text-align:left; float:left;margin-top:40px;">
			...
			<table>
			<?php
			$que=mysql_query("select * from `category` where `status`='1'");
			while($res=mysql_fetch_array($que))
			{
			
			?>
				<tr><td onclick="return getp(<?php echo $res['id'];?>);"><?php echo $res['category_name'];?></td></tr>
			<?php
			}
			?>
