...
<body>
  ...
  <tr>
   ...
   <tr>
    <td >Make my Pc Priority: </td>
    <td><input type="text" name="mpc_priority" style=" border:1px solid #CCCCCC;"/></td>
  </tr>
  ...
  <tr>
   ...
   <td>
	<div style=" height: 300px; width: 200px; overflow: auto; float: left;  ">
