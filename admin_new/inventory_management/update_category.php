...
<body>
		...
		<?php
		$sql=mysql_query("select * from `category` where `id`='$id'")or die(mysql_error());
		$result=mysql_fetch_array($sql);
		 ?>
		
		
		<div id="container">
		<form action="update_dbcategory.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    <td width="21%" >Name:</td>
    <td colspan="2"><input type="text" name="product_name" style=" border:1px solid #CCCCCC;" value="<?php echo $result['category_name'];?>"/></td>
  ...
  <td> <img src="<?php echo $result['img'];?>" width="50px" height="60px" /></td>
  </tr>
