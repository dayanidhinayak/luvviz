...
<title>Mapkart Admin panel product edit</title>
...
$r=mysql_fetch_array($q);
		?>
		<form name="form1" method="post" action="update_monitoring.php" enctype="multipart/form-data">
  ...
  <tr>
    <td width="21%" >Name:</td>
    <td colspan="2"><input type="text" name="name" style="width:78%; border:1px solid #CCCCCC;" value="<?php echo $r['product_name'];?>" readonly/> <input type="hidden" name="id" value="<?php echo $id;?>"/></td>
                ...
                <div style="display: none;" class="tab-content">
				   ...
				   <table style="width:70%; margin-top:1%; ">
				   		<tr>
							...
							<td style="width:50%;"><input type="text" name="price"  style="width:100px; height:20px; border:1px solid #CCCCCC;" value="<?php echo $r['selling_price'];?>" readonly/>&nbsp;&nbsp;<?php echo $rc['symbol'];?>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><input type="text" name="sellingprice"  style="width:100px; height:20px; border:1px solid #CCCCCC;" value="<?php echo $r['price'];?>" readonly/>&nbsp;&nbsp;<?php echo $rc['symbol'];?>
							</td>
						</tr>
						<tr>
							<td>Recurring price:</td>
							<td><input type="text" name="recurringprice"  style="width:100px; height:20px; border:1px solid #CCCCCC;"  value="<?php echo $r['recurring_price'];?>" readonly/>&nbsp;&nbsp;<?php echo $rc['symbol'];?>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
							<td>Unit price:</td>
							<td><input type="text" name=""  style="width:100px; height:20px; border:1px solid #CCCCCC;" />&nbsp;&nbsp;<?php echo $rc['symbol'];?> per<input type="text" name=""  style="width:100px; height:20px; border:1px solid #CCCCCC;" />or 0.00 € per with tax </td>
						</tr>
						<tr>
							<td>&nbsp;</td>
					 ...
					 <div id="separation" style="width:100%; margin-left:0%;">
					  ...
					  <table style="width:70%; margin-top:1%; ">
				   		<tr>
							...
							<td style="width:55%;"><input type="text" name=""  style="width:100px; height:20px; border:1px solid #CCCCCC;" />&nbsp;&nbsp;<?php echo $rc['symbol'];?>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
                ...
                <div style="display: none;" class="tab-content">
                   <h5 style="font-weight:bold; font-size:17px; background:none; margin-top:0px;">Associations</h5>
						...
						<table style="width:100%;">
							...
							<td style="width:30%;"><input type="text" name="cat_id" id="cat_id"  style="width:150px; height:20px; border:1px solid #CCCCCC; float:left; display:none;" value="<?php echo $r['category_id'];?>" readonly/> 
							<?php
							$value='';
...
?>
	 <option value="<?php echo $r['brand_id'];?>"><?php echo $rbrand['brand_name']; ?></option>
				 ...
				 <div style="display: none;" class="tab-content">
                    <h5 style="font-weight:bold; font-size:17px; background:none; margin-top:0px;">Add a new image to this product</h5>
					 ...
					 <table align="center" style="width:50%;">
					 	<tr>
							<td>File:</td>
							<td><input type="file" name="prodct_img"  readonly /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
						<td>Alternate:</td>
						<td><input type="text" name="alt" value="<?php echo $r['alternate_val']; ?>"/></td>
						</tr>
					 </table>
					 
					  <div id="separation" style="width:100%; margin-left:0%;">
				     </div>
					 <img src="<?php echo $r['image'];?>" height="40" width="40" />
...
You can either create a specific value or select among existing pre-defined values you added previously.</td>
							...
							<div id="separation" style="width:100%; margin-left:0%;">
								...
								<table cellpadding="5" cellspacing="0" style="width:100%; background:#FFFFFF; border:1px solid #CCCCCC; margin-top:2%;" >
									...
									{
									$q2=mysql_query("select * from `product_varient` where `varient_name`='$rwe[varient_name]' and `product_id`='$id'");
$r2=mysql_fetch_array($q2);									
									?>
									<tr>
										<td><input type="text" value="<?php echo $rwe['varient_name'];?>" name="vname<?php echo $rwe['varient_name'];?>" readonly=""/></td>
										<!--<td>N/A-  <input type="button" name="submit" value="Add predefined value first"  /></td>-->
										<td><input type="text" name="varient[<?php echo $rwe['varient_name'];?>]" style="width:200px; height:20px; border:1px solid #cccccc; " value="<?php echo $r2['description'];?>" /></td>
									</tr>
									<?php
									}
									?>
