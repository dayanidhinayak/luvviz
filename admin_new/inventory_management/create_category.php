...
<div id="container100" style=" margin-top:10px; background:#ffffff;">
			...
			<form name="form" action="insert_category.php" method="post" enctype="multipart/form-data" >

<table width="300" height="100" style="margin-top:20px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666666;" >
...
<tr><td>&nbsp;</td><td><input type="submit" name="submit" value="Add" class="learnmore" style="border:none;" /></td></tr>
