...
$q=mysql_query("select o.`slno`,o.`id`,o.`billing_name`,o.`billing_phn` from `order_details` o,`order_type` ot where o.`id`=ot.`billid` and ot.`order_type`='POS'");
...
<tr>
	 ...
	 <td><?php echo $r['billing_phn'];?></td>
      <td><a href="view_pos_detail.php?id=<?php echo $r['slno'];?>">View Details</a></td>
</tr>
<?php } ?>
</table>
