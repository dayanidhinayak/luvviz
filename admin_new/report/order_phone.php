...
$q=mysql_query("select o.`slno`,o.`id`,o.`billing_name`,o.`billing_phn`,ot.`attendant_name` from `order_details` o,`order_type` ot where o.`id`=ot.`billid` and ot.`order_type`='PHONE' and `status`='0'");
...
<tr>
	 ...
	 <td><?php echo $r['attendant_name'];?></td>
      <td><a href="view_phone_detail.php?id=<?php echo $r['slno'];?>">View Details</a></td>
</tr>
<?php } ?>
</table>
