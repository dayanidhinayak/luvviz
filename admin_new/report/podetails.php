...
<body>
<form name="form1" method="post" action="insert_poapproval.php">
<table>
...
$que=mysql_query("select * from `purchase_order` where `order_id`='$orderid' and `approval_status`='0'");
