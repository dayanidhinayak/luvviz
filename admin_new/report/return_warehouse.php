...
<?php 
$q=mysql_query("select p.`order_by`,r.`purchase_id` from `return_product` r,`purchase_order` p where r.`purchase_id`=p.`order_id` group by r.`purchase_id` ");
while($r=mysql_fetch_array($q))
{
?>
<tr>
     <td><?php echo $r['order_by'];?></td>
	 <td><?php echo $r['purchase_id'];?></td>
	 <td><a href="view_return_detail.php?purchase_id=<?php echo $r['purchase_id'];?>">View Detail</a></td>
</tr>
<?php
}
?>
