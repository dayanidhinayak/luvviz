...
$q=mysql_query("select o.`slno`,o.`id`,o.`billing_name`,o.`billing_phn`,ot.`attendant_name` from `order_details` o,`order_type` ot where o.`id`=ot.`billid` and ot.`order_type`='PHONE' and `status`='1'");
