...
$q=mysql_query("select o.`slno`,o.`id`,o.`billing_name`,o.`billing_phn` from `order_details` o,`order_type` ot where o.`id`=ot.`billid` and ot.`order_type`='ONLINE CART' and `status`='1'");
