...
$q=mysql_query("select `slno`,`id`,`billing_name`,`billing_phn` from `order_details` where `order_ondate` like '$date%' and `status`='0'");
...
<tr>
	 ...
	 <td><?php echo $r['billing_phn'];?></td>
      <td><a href="view_day_detail.php?id=<?php echo $r['slno'];?>">View Details</a></td>
</tr>
<?php } ?>
</table>
